...
#Uso: mutation-finder.py seqFile.fasta

programName = "mutation-finder"
programVersion = "0.1"
licenseVersion = " GNU v 3.0"
homepageProyect = "https://github.com/Franklin-X-Ray-Archives/mutation-finder"
...
# Returns the highest index of the substring inside the string (if found). If the substring is not found, it raises an exception.
        ...
        print ("No arguments detected","\n","Usage:","mutation-finder.py seqFile.fasta")
